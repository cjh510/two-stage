...
# from Src.networks.modules import Diverging_decoder
...
class map_project(nn.Module):
    ...
    def forward(self, feacture):
        ...
        # print(feacture0.shape, feacture1.shape, feacture2.shape, feacture3.shape, feacture4.shape)
...
if __name__ == '__main__':
    import yaml
    yaml_file = '/home/fresh/Lynos/gcn_transformer_v1/Src/yaml/mulorganseg_base.yaml'
